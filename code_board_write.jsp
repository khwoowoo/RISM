...
<span class="pageTitle" style="text-indent: 30px;"> 코드 조각모음게시판 글 작성 </span>
<div class="horizontal_line" style="height:2px; width:auto; background-color: grey; margin-top:3px; margin-bottom:10px;"></div>

<form id="uploadForm" method="post" action="BoardUpload.jsp?board_type=code_board" enctype="multipart/form-data">
...
<tr>
	...
	<td style="text-indent:20px"><input type="file" name="file"></td>
</tr>
<tr>
