...
<span class="pageTitle" style="text-indent: 30px;"> 스터디게시판 글 작성 </span>
<div class="horizontal_line" style="height:2px; width:auto; background-color: grey; margin-top:3px; margin-bottom:10px;"></div>

<form id="uploadForm" method="post" action="BoardUpload.jsp?board_type=study_board" enctype="multipart/form-data">
<input name="studyid" value="<%=request.getParameter("studyid") %>"  type="hidden">
...
<tr>
	<td colspan="2" style="text-align:center"><input type="button" class="submitbtn" value="글 작성" /></td>
</tr>
</table>
